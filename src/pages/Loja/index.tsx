          ...
          <View style={styles.all}> 
            <RectButton style={styles.cartaz2} >
              ...
              <View style={styles.escrita}>
                <Text style={styles.descricao}>Detalhes do Produto</Text>
                <Text style={styles.descricao}>Conjunto jeans</Text>
                <Text style={styles.descricao}>Tamanho: M Cor: Jeans</Text>
                <Text style={styles.descricao}>Disponível para retirada</Text>
              </View>
              </RectButton>
            <RectButton style={styles.cartaz2} >
              <Image source={require("../../assets/confeiteira.jpg") } />
            <View style={styles.escrita}>
              <Text style={styles.descricao}>Nome: Juliana Corte Lima</Text>
              <Text style={styles.descricao}>Resumo: Costureira autônoma</Text>
              <Text style={styles.descricao}>Endereço de Retirada:</Text>             
              <Text style={styles.descricao}>Rua dos Bobos, número zero</Text>
            </View>
            </RectButton>
          </View>          
        </View>
